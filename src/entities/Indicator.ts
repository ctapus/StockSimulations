...
export class IndicatorTypes {
    public static readonly OPEN                   = new IndicatorType("OPEN", "Open");
    ...
    public static readonly SMA_10_DAYS            = new IndicatorType("SMA_10_DAYS", "Simple Moving Average 10 Days");
    public static readonly SMA_20_DAYS            = new IndicatorType("SMA_20_DAYS", "Simple Moving Average 20 Days");
    ...
    public static AllIndicatorTypes: IndicatorType[] = [ this.OPEN, this.PREV_BUY, this.MIN_52_WEEK, this.MAX_52_WEEK, this.SMA_10_DAYS, this.SMA_20_DAYS, this.SMA_50_DAYS,
...
export class Indicator {
    ...
    public evaluate(tradeTick: StockHistoryItem, portofolio: Portofolio): number {
        switch(this.indicatorType) {
            case IndicatorTypes.OPEN: return tradeTick.open;
            ...
            case IndicatorTypes.SMA_10_DAYS: return tradeTick.sma10Days;
            case IndicatorTypes.SMA_20_DAYS: return tradeTick.sma20Days;
